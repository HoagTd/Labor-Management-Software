...
//						chá»�n cbo cÃ´ng viá»‡c
						...
						if (listTrung.size() == 0) {
							int kt = JOptionPane.showConfirmDialog(null, "Bạn muốn sửa", "Thông báo",
...
//					neu khong chon
					...
					if (!kt) {
						...
						JOptionPane.showMessageDialog(null, "Lao Ä‘á»™ng Ä‘Ã£ bá»‹ trÃ¹ng lá»‹ch");
					}
				}
			}
	...
	public boolean kiemTra() {
		...
		Date ht = chuyenNgay(ngayHoanThanh.getDate());
		if (th.after(ht)) {
			JOptionPane.showMessageDialog(null, "Ngày thực hiện phải trùng ngày hoàn thành");
			return false;
		}
