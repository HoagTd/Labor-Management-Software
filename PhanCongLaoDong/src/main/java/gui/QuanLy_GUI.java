...
public class QuanLy_GUI extends JFrame implements MouseListener {
	...
	public QuanLy_GUI(QuanLy ql) {
		...
		ImageIcon img = new ImageIcon(QuanLy_GUI.class.getResource("/images/lao_dong.png"));
		...
		tabbedPane.addTab("Quản lý lao động", new ImageIcon(QuanLy_GUI.class.getResource("")),
				new QuanLiLaoDongJPanel(), "Quản lý lao động");
		tabbedPane.addTab("Quản lý công trình", new ImageIcon(QuanLy_GUI.class.getResource("")),
				null, "Quản lý công trình");
		tabbedPane.addTab("Phân công lao động", new ImageIcon(QuanLy_GUI.class.getResource("")),
				null, "Phân công lao động");
		tabbedPane.addTab("Chuyển lao động", new ImageIcon(QuanLy_GUI.class.getResource("")), null,
				"Chuyển lao động");
		tabbedPane.addTab("Lịch làm việc", new ImageIcon(QuanLy_GUI.class.getResource("")), null,
				"Lịch làm việc");
		tabbedPane.addTab("Thống kê", new ImageIcon(QuanLy_GUI.class.getResource("")), null, null);
		tabbedPane.addTab("Quản lý công việc", new ImageIcon(QuanLy_GUI.class.getResource("")), null,
				null);
//		tabbedPane.setBackground(new Color(50, 168, 82));
		...
		btnDangXuat.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int t = JOptionPane.showConfirmDialog(null, "Bạn muốn đăng xuất", "Thông báo",
...
//		
//		
//		btnTroGiup.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke(KeyEvent.VK_F1, 0), "Trá»£ giÃºp");
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (index == 0 && kt != index)
			tabbedPane.insertTab("Quản lý lao động",
					new ImageIcon(QuanLy_GUI.class.getResource("")), new QuanLiLaoDongJPanel(),
					"Quản lý lao động", index + 1);
		else if (index == 1 && kt != index)
			tabbedPane.insertTab("Quản lý công trình",
					new ImageIcon(QuanLy_GUI.class.getResource("")), new QuanLiCongTrinhJPanel(),
					"Quản lý công trình", index + 1);
		else if (index == 2 && kt != index)
			tabbedPane.insertTab("Phân công lao động",
					new ImageIcon(QuanLy_GUI.class.getResource("")), new PhanCong_JPN(this.quanLy),
					"Phân công lao động", index + 1);
		else if (index == 3 && kt != index)
			tabbedPane.insertTab("Chuyển lao động", new ImageIcon(QuanLy_GUI.class.getResource("")),
					new ChuyenLaoDong_JPN(quanLy), "Chuyển lao động", index + 1);
		else if (index == 4 && kt != index)
			tabbedPane.insertTab("Lịch làm việc", new ImageIcon(QuanLy_GUI.class.getResource("")),
					new QLLichLamViec(), "Lịch làm việc", index + 1);
		else if (index == 5 && kt != index)
			tabbedPane.insertTab("Thống kê", new ImageIcon(QuanLy_GUI.class.getResource("")),
					new ThongKe_Jpanel(), "Thống kê", index + 1);
		else if (index == 6 && kt != index)
			tabbedPane.insertTab("Quản lý công việc", new ImageIcon(QuanLy_GUI.class.getResource("")),
