...
public class QLCongViec_GUI extends JPanel implements ActionListener, MouseListener, ItemListener, KeyListener {
	...
	public QLCongViec_GUI() {
		...
		tbCongViec.getTableHeader().setForeground(new Color(255, 255, 255));
		tbCongViec.getTableHeader().setBackground(new Color(146, 200, 240));
		...
		add(pnlCT);
		pnlCT.setBorder(BorderFactory.createTitledBorder("CÃ´ng trÃ¬nh"));
			...
			if (validata()) {
				...
				for (CongViec cv : listCongViec) {
					if(ten.equalsIgnoreCase(cv.getTenCongViec().trim())) {
						JOptionPane.showMessageDialog(null, "Tên công việc không giống nhau vui lòng chọn tên khác");
						return;
					}
				}
	...
	private boolean validata() {
		...
		if (!txtTenCV.getText()
				.matches("[aAÃ Ã€áº£áº¢Ã£ÃƒÃ¡Ã�áº¡áº ÄƒÄ‚áº±áº°áº³áº²áºµáº´áº¯áº®áº·áº¶Ã¢Ã‚áº§áº¦áº©áº¨áº«áºªáº¥áº¤áº­áº¬bBcCdDÄ‘Ä�eEÃ¨Ãˆáº»áººáº½áº¼Ã©Ã‰áº¹áº¸ÃªÃŠá»�á»€á»ƒá»‚á»…á»„áº¿áº¾á»‡á»†\r\n"
						...
						+ "UÃ¹Ã™á»§á»¦Å©Å¨ÃºÃšá»¥á»¤Æ°Æ¯á»«á»ªá»­á»¬á»¯á»®á»©á»¨á»±á»°vVwWxXyYá»³á»²á»·á»¶á»¹á»¸Ã½Ã�á»µá»´zZ ,0-9]+")) {
